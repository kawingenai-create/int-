...
const Footer: React.FC = () => {
  ...
  // Console message for recruitment
  useEffect(() => {
    console.log('%c🚀 You are interested to join our team? Send your works at integer.io.ai@gmail.com',
      'color: #10b981; font-size: 14px; font-weight: bold; padding: 10px;');
  }, []);
